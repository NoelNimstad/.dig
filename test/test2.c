...
int main(void)
{
	dig_t *characters = dig_initialise("test/characters.dig", character_interface, dig_set_character, sizeof(character_t));
	dig_t *dialogue = dig_initialise("test/dialogue.dig", dialogue_interface, dig_set_dialogue, sizeof(dialogue_t));
